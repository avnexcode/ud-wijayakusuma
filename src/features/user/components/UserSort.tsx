...
export type UserSortParams = "name" | "created_at";
export type UserOrderParams = "asc" | "desc";

type UserSortProps = {
  currentSort?: string;
  currentOrder?: string;
  onSortChange: (sort: UserSortParams) => void;
  onOrderChange: (order: UserOrderParams) => void;
};
